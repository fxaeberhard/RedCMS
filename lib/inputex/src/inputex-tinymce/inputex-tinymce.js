...
YUI.add("inputex-tinymce", function(Y) {
	...
	Y.extend(inputEx.TinyMCEField, inputEx.Field, {
		defaultOpts: {
			...
			language: "en",
			theme: "advanced",
			plugins: "paste,autolink,lists,table,inlinepopups,contextmenu,advlist", // past plugin for raw text pasting
			//advlink, advimage,media
			paste_auto_cleanup_on_paste: true,
			paste_remove_styles: true,
			paste_remove_styles_if_webkit: true,
			paste_strip_class_attributes: true,
			file_browser_callback: function(field_name, url, type, win) {
				var label = "Files", href = Y.RedCMS.Config.path + "fileManager/";
				switch (type) {
					case "page":
						label = "Pages";
						href = Y.RedCMS.Config.path + "/pageManager/";
						break;
					case "image":
			...
			theme_advanced_buttons2: "link,unlink,image,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,outdent,indent,|,tablecontrols,",
