...
YUI.add("inputex-tinymce", function(Y) {
    ...
    Y.extend(inputEx.TinyMCEField, inputEx.Field, {
        defaultOpts: {
            ...
            language: "en",
            theme: "advanced",
            plugins: "paste,autolink,lists,table,advimage,advlink,inlinepopups,media,contextmenu,advlist", // past plugin for raw text pasting
            paste_auto_cleanup_on_paste: true,
            paste_remove_styles: true,
            paste_remove_styles_if_webkit: true,
            paste_strip_class_attributes: true,
            theme_advanced_buttons1: "formatselect,fontselect,fontsizeselect,|,bold,italic,underline,strikethrough,|,forecolor,backcolor,|,outdent,indent,blockquote,hr,|,undo,redo",
            theme_advanced_buttons2: "justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,link,unlink,image,|, tablecontrols,|,iespell,cleanup,removeformat,code",
