...
Y.extend(inputEx.Form, inputEx.Group, {
   ...
   setOptions: function(options) {
      ...
      this.options.action = options.action;
   	this.options.method = options.method;
		this.options.blockType = options.blockType || "div";
   ...
   render: function() {
      ...
      this.form = inputEx.cn(this.options.blockType, {method: this.options.method || 'POST', action: this.options.action || '', className: this.options.className || 'inputEx-Form'});
   ...
   asyncRequest: function() {
      ...
      var f = Y.one(this.form),
		...
		if (this.options.blockType === "form") {
			cfg.form = {id: f, upload: true};
		} else {
			cfg.data = postData;
		}
...
//         "<div class='inputEx-Form-Mask-bg'/><center><br/><div class='inputEx-Form-Mask-spinner'></div><br /><span>"+inputEx.messages.ajaxWait+"</span></div>");
         "<div class='inputEx-Form-Mask-bg'/><center><br/><div class='inputEx-Form-Mask-spinner'></div><br /><span></span></div>");
