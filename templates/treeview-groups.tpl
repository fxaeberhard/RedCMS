...
<div class="redcms-block yui3-redcms-loading yui3-redcms-treeview-content" {$this->renderBlockAttributes()}
	...
	<button class='yui3-button' widget='OpenPanelAction' params='{ "parentId":12 }' href="{$redCMS->path}200/" data-cfg='{ "onSuccessEvent": "dirty" }'><i class='fa fa-plus-square'></i> New group</button>
	<br /><br />
	<div>
        [
